...
def attack1_main_mnist():
  ...
  target_best_net, target_best_acc, target_last_net = train_model(target_net, target_train_loader, target_unk_loader, criterion, optimizer_ft, exp_lr_scheduler, num_epochs=30)
...
def attack1_main_fmnist():
  ...
  best_net, best_acc, last_net = train_model(fashion_net, shadow_train_loader, shadow_test_loader, criterion, optimizer_ft, exp_lr_scheduler, num_epochs=30)
  ...
  target_best_net, target_best_acc, target_last_net = train_model(fashion_target_net, target_train_loader, target_unk_loader, criterion, optimizer_ft, exp_lr_scheduler, num_epochs=30)
