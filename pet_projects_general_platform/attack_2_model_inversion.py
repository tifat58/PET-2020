...
# Uncomment this if you want to run it on google colab and save the trained models
...
def main_fmnist():
  ...
  train_model(fashion_net, criterion, optimizer_ft, fashion_data.train_loader, exp_lr_scheduler, num_epochs=15)
